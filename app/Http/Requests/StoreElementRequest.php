...
class StoreElementRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $fromForm = $this->input('config');
        $config = is_array($fromForm) ? $fromForm : [];
        ...
        if (is_string($type) && $type !== ElementType::Screenshot->value) {
    ...
    public function rules(): array
    {
        return [
            ...
            'config.url' => ['required_if:type,'.ElementType::Screenshot->value, 'url', 'max:2048'],
